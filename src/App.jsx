    ...
    <div className="min-h-screen bg-[#0a0a0a] text-gray-100 font-sans selection:bg-purple-500/30">
      ...
      <header className="flex flex-col items-center justify-center text-center py-32 px-6">
        ...
        <div className="mt-12 flex gap-4">
          <button onClick={() => alert('Email me at: letscodewithsumit@gmail.com')} className="bg-white text-black px-8 py-4 rounded-xl font-bold hover:scale-105 transition active:scale-95">Get in touch</button>
